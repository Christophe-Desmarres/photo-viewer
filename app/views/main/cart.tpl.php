    ...
    <form class="cart__preview" action="/cart_send" method="post" autocomplete="off">
        ...
        ?>
            ...
            <div class="input__list">
                <input class="input__customer" placeholder="Nom" type="text" id="lastname" name="customer[lastname]" value="<?= isset($_SESSION['customer']['lastname']) ? $_SESSION['customer']['lastname'] : "" ?>" autocomplete="off" required>
                <input class="input__customer" placeholder="Prénom" type="text" id="firstname" name="customer[firstname]" value="<?= isset($_SESSION['customer']['firstname']) ? $_SESSION['customer']['firstname'] : "" ?>" autocomplete="off" required>
                <input class="input__customer" placeholder="Pseudo" type="text" id="pseudo" name="customer[pseudo]" value="<?= isset($_SESSION['customer']['pseudo']) ? $_SESSION['customer']['pseudo'] : "" ?>" autocomplete="off" required>
                <input class="input__customer" placeholder="email" type="email" id="email" name="customer[email]" value="<?= isset($_SESSION['customer']['email']) ? $_SESSION['customer']['email'] : "" ?>" autocomplete="off">
            </div>
                ...
                ?>
                    ...
                    <tr class="row row<?= $index ?>">
                        ...
                        <td class="nblight">
                            ...
                            <div>
                                <a href="/cart/lightplus/<?= $image->id ?>"><button class="plus light" type="button" name="plus">+</button></a>
                            </div>
                            <div>
                                <a href="/cart/lightminus/<?= $image->id ?>"><button class="minus light" type="button" name="minus">-</button></a>
                            </div>
                        </td>
                        <td class="nblarge">
