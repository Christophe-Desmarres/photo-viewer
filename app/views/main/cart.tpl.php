    ...
    <form class="cart__preview" action="/cart_send" method="post" autocomplete="off">
        ...
        ?>
            ...
            <div class="input__list">
                ...
                <input class="input__customer" placeholder="email" type="email" id="email" name="customer[email]" value="<?= $_SESSION['customer'] != null ? $customer['email'] : "" ?>" autocomplete="off" required>
